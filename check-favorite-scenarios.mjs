...
for (const marker of ['favorite-scenario-card','scenario-watch-low','scenario-watch-high','scenario-confirm','scenario-target','scenario-invalidation','saveFavoriteScenario','renderFavoriteScenario','FAVORITE_SCENARIO_KEY','ensureAutoFavoriteScenario','/api/live-terminal/technicals/','confidence','generatedAt']) assert.match(html, new RegExp(marker));
