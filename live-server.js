...
app.get('/health',(_q,res)=>res.json({ok:true,service:'asiri-capital-live',version:'7.4.1-batched-quotes',alerts:true,smartAlerts:true,decisionEngine:true,batchedQuotes:true,time:new Date().toISOString()}));
