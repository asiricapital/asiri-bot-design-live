...
app.get('/health',(_q,res)=>res.json({ok:true,service:'asiri-capital-live',version:'7.6.0-mobile-stock-intelligence',alerts:true,smartAlerts:true,decisionEngine:true,batchedQuotes:true,dynamicRanking:true,stockIntelligence:true,time:new Date().toISOString()}));
